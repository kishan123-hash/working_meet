...
def google_verification():
    verification_file = os.path.join(
        ...
        'google6f621bdcff4cdb42.html'
    )

    if not os.path.exists(verification_file):
        return f"Google verification file not found: {verification_file}", 404

    return send_file(verification_file)
...
def robots_txt():
    return (
        "User-agent: *\n"
        "Allow: /\n"
        "Sitemap: https://working-meet.onrender.com/sitemap.xml\n",
        200,
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    <url>
        <loc>https://working-meet.onrender.com/</loc>
    </url>
